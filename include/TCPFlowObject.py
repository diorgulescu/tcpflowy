...
class TCPFlowObject:
    ...
    def __init__(self, flow_id):
        ...
        self.dst_fqdn = None
        self.src_fqdn = None
        self.src_attributes = None
        self.dst_attributes = None
    ...
    def get_ip_info(self, ip):
        ...
        # ip-tracer updates will change its functionality
